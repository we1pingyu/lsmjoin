...
for c in "${cs[@]}"; do
    for k in "${ks[@]}"; do
        ...
        clear_path
        ./exp_runner --J="SJ" --r_index="Comp" --s_index="CComp" --output_file=$output --r_tuples=$r_tuples --s_tuples=$s_tuples --db_r=$db_r_path --db_s=$db_s_path --r_index_path=$index_r_path --s_index_path=$index_s_path --k_s=$k --k_r=$k --c_r=$c
        clear_path
