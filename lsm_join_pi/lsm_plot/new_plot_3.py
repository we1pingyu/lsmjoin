...
# # pair info
pairs = [['P-INLJ'], ['P-ISJ'], ['P-Eager-ISJ', 'P-Lazy-ISJ', 'P-Comp-ISJ'], ['P-CEager-ISJ', 'P-CLazy-ISJ', 'P-CComp-ISJ'], ['P-Grace-HJ']]
x_labels = ['P-INLJ', 'P-ISJ', 'P*-ISJ', 'P-C*-ISJ', 'HJ']

# pairs = [['Eager-INLJ', 'Lazy-INLJ', 'Comp-INLJ'], ['CEager-INLJ', 'CLazy-INLJ', 'CComp-INLJ'], ['Grace-HJ']]
# x_labels = ['*-INLJ', 'C*-INLJ', 'HJ']

# pairs = [['NISJ'], ['1Eager-ISJ', '1Lazy-ISJ', '1Comp-ISJ'], ['1CEager-ISJ', '1CLazy-ISJ', '1CComp-ISJ'], ['2Eager-ISJ', '2Lazy-ISJ', '2Comp-ISJ'], ['2CEager-ISJ', '2CLazy-ISJ', '2CComp-ISJ']]
# x_labels = ['NISJ', '1*-ISJ', '1C*-ISJ', '2*-ISJ', '2C*-ISJ']

# get num of elements in pairs
num_pairs = sum([len(pair) for pair in pairs])
...
if rows > 1:
    ...
    fig.legend(handles=legend_patches, bbox_to_anchor=(0.5, 0.96),
        ncol=4, fontsize=12)
