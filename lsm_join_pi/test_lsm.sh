...
data_path="/home/wyu/code/lsm_join_data/"
...
for T in "${nums[@]}"; do
    ...
    # SJ, Regular, Lazy
    # ./exp_runner --M=16 --B=128 --ingestion --J="SJ" --r_index="Eager" --s_index="Eager" --num_loop=1 --output_file=$output --r_tuples=$r_tuples --s_tuples=$s_tuples --T=$T --public_data --public_r=$public_r --public_s=$public_s --db_r=$db_r_path --db_s=$db_s_path --r_index_path=$index_r_path --s_index_path=$index_s_path --theory
    # # SJ, Lazy, Lazy
    ...
    # SJ, Regular, CLazy
    # ./exp_runner --M=16 --B=128 --ingestion --J="SJ" --r_index="Regular" --s_index="CLazy" --num_loop=1 --output_file=$output --r_tuples=$r_tuples --s_tuples=$s_tuples --T=$T --public_data --public_r=$public_r --public_s=$public_s --db_r=$db_r_path --db_s=$db_s_path --r_index_path=$index_r_path --s_index_path=$index_s_path --theory
    # HJ, Regular, Regular
...
for T in "${nums[@]}"; do
    ...
    # SJ, Regular, Lazy
    # ./exp_runner --M=16 --B=128 --ingestion --J="SJ" --r_index="Eager" --s_index="Eager" --num_loop=1 --output_file=$output --r_tuples=$r_tuples --s_tuples=$s_tuples --T=$T --public_data --public_r=$public_r --public_s=$public_s --db_r=$db_r_path --db_s=$db_s_path --r_index_path=$index_r_path --s_index_path=$index_s_path
    # SJ, Lazy, Lazy
...
for M in "${nums[@]}"; do
    ...
    # SJ, Regular, Lazy
    # ./exp_runner --M=$M --B=128 --ingestion --J="SJ" --r_index="Eager" --s_index="Eager" --num_loop=1 --output_file=$output --uniform --public_data --public_r=$public_r --public_s=$public_s --db_r=$db_r_path --db_s=$db_s_path --r_index_path=$index_r_path --s_index_path=$index_s_path --theory
    # SJ, Lazy, Lazy
...
for M in "${nums[@]}"; do
    ...
    # SJ, Regular, Lazy
    # ./exp_runner --M=$M --B=128 --ingestion --J="SJ" --r_index="Eager" --s_index="Eager" --num_loop=1 --output_file=$output --uniform --public_data --public_r=$public_r --public_s=$public_s --db_r=$db_r_path --db_s=$db_s_path --r_index_path=$index_r_path --s_index_path=$index_s_path
    # SJ, Lazy, Lazy
